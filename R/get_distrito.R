...
#' 
#' 
#' @param url character. An idealista website url that links to the city district you want to scrap, e.g. 'https://www.idealista.com/alquiler-viviendas/madrid-provincia/'.
...
#' @export
get_distrito <- function(url, ruta = "~/idealisto_distrito.csv", silent = FALSE) {
  start <- Sys.time()
